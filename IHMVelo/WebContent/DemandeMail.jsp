				...
				<header id="fh5co-header-section">
					<div class="container">
						<div class="nav-header">
							...
							<h1 id="fh5co-logo">
								<a href="index.html">PARADISEBIKE</a>
							</h1>
								...
								<form method="post" action="RechercheClient">
									<div class="a-col">
										<div class="input-field">
											<label for="date-start">Adresse Mail</label>
											<input type="email" size="32" class="form-control" name="mail" placeholder="sophie@example.com"/>
										</div>
									</div>
		...
		<div id="fh5co-counter-section" class="fh5co-counters">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<span class="fh5co-counter js-counter" data-from="0"
							data-to="5" data-speed="500" data-refresh-interval="1"></span>
						<span class="fh5co-counter-label">Types de vélos</span>
					</div>
					<div class="col-md-3 text-center">
						<span class="fh5co-counter js-counter" data-from="0"
							data-to="3" data-speed="500" data-refresh-interval="1"></span>
